...
c original version by David Nesvorny, modified by MB
      ...
      real*8 rad(BINMAX),numb,cumul5
      real*8 r1,r2,r3,r4,qa,qb,qc,qd,qe,rmax,r_norm,n_norm,rmin
      real*8 lrbin,lrbin_start,lrbin_end,nstart,nend
      real*8 rstart,rend
      real*8 numb_int(BINMAX),ncum1(BINMAX),ncum2(BINMAX)
      real*8 dpi,totm,dm
      real*8 d1,d2,d3,d4,dmin,dmax,d_norm
...
c... Read input parameters
      if (iargc().eq.0) then
        ...
        write(*,*) 'Usage: gen_sfd  rho d1 d2 d3 d4 qa qb qc qd qe ',
...
c...  Calculate number of objects in each bin
      do i=1,nbin
        ...
        nstart = cumul5(rmax,r1,r2,r3,r4,qa,qb,qc,qd,qe,r_norm,n_norm,
     :    rstart)
        nend = cumul5(rmax,r1,r2,r3,r4,qa,qb,qc,qd,qe,r_norm,n_norm,
     :    rend)
        numb = nstart - nend
c...  Round things
...
c...  Calculate cumulative
      ...
      do i=1,nbin
        ncum2(i) = cumul5(rmax,r1,r2,r3,r4,qa,qb,qc,qd,qe,r_norm,n_norm,
     :    rad(i))
      end do
